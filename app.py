...
with tabs[5]:
    ...
    if model is None:
        ...
        if submitted:
            # Build a single-row DataFrame matching training columns as much as possible
            raw_features = {
                "year": year_in,
                "odometer": odo_in,
            ...
            # Use the same feature assembly as training
            X, _, _ = assemble_feature_frame(raw_df, include_engineered=True)
